...
export const FoodForHealthTemplate: React.FC<TemplateProps> = ({ data, onUpdate }) => {
  ...
  return (
    <div className="a4-sheet text-slate-900 relative bg-white flex flex-col justify-between p-0 shadow-lg font-sans overflow-hidden h-[297mm] min-h-[297mm] max-h-[297mm] box-border">

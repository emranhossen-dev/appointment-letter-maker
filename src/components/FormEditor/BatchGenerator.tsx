  ...
  const [employees, setEmployees] = useState<BatchEmployeeInput[]>([
    {
      ...
      designation: data.employee.designation || 'Web Designer',
      department: data.employee.department || '',
      baseSalary: data.compensation.baseSalary || 18000,
      issueDate: data.employee.issueDate || '2026-05-02',
      joiningDate: data.employee.joiningDate || '2026-05-02',
    },
    {
      id: '2',
      name: 'Rahima Khatun',
